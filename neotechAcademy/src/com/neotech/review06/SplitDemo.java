...
public class SplitDemo {
	...
	public static void main(String[] args) {
		...
		String[] stringArray=longStr.split("[5-7]");//looking for numbers 5, 6, 7 
	//	String[] stringArray=longStr.split("[5,7]"); // the , is treated as a delimiter (if there is a coma in the String, it will split on that)
